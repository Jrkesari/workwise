...
export default function NavBar() {
  ...
  return (
    <>
      ...
      >
        <div className="px-2 h-full flex items-center justify-end">
        ...
        <div className="px-2 h-full hidden items-center justify-center lg:flex space-x-4">
          {user !== null ? (
            <>
              <Link href={"/"}>Home</Link>
              <Link href={"/frontend/postAJob"}>Post Jobs</Link>
              <Link href={"/frontend/displayJobs"}>View Jobs</Link>
              <Link href={"/frontend/postedJob"}>Posted Jobs</Link>
              <Link href={"/frontend/dashboard"}>Dashboard</Link>
            ...
            <>
              <Link
                href={"/auth/login"}
                className="px-4 py-2 border border-white rounded uppercase tracking-widest transition-all duration-700 hover:bg-white font-semibold text-base hover:text-indigo-600"
              >
                Login
              </Link>
              <Link
                href={"/auth/register"}
                className="px-4 py-2 border border-white rounded uppercase tracking-widest text-indigo-600 bg-white transition-all duration-700 hover:bg-transparent font-semibold text-base hover:text-white"
              >
                REGISTER
              </Link>
            </>
